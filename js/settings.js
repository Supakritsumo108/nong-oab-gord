...
let isSettingsInit = false; // ตัวแปรป้องกันการสร้าง Event Listener ซ้ำ

/**
 * โหลดข้อมูลมาแสดงในหน้า Settings
 */
...
/**
 * เริ่มต้น Event Listeners ของหน้า Settings (เรียกครั้งเดียวพอ)
 */
export function initSettings() {
  if (isSettingsInit) return; // ถ้าเคย init แล้ว ให้จบการทำงานทันที

  console.log("⚙️ Initializing Settings Events...");
  ...
  isSettingsInit = true; // มาร์คว่า init แล้ว
}
